...
<%
    ...
    if (httpSession == null || httpSession.getAttribute("authenticated") == null || httpSession.getAttribute("usuario") == null) {
        ...
        Comunidade comunidade = (Comunidade) httpSession.getAttribute("comunidade");
        fotoPerfil = comunidade.getFotoPerfil();
        fotoFundo = comunidade.getFotoFundo();
...
<head>
    ...
    <link rel="stylesheet" href="DonoComunidade.css">
    <link
            ...
            <div
                ...
                <div>
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <p class="h5 nomeComunidade" style="margin-left: 50px;"><%=nome%></p>
                    </div>
                    <p class="descricaoComunidade" style="margin-left: 50px; width: 80%;"><%=descricao%></p>
                ...
                <div class="postar"
                    ...
                    <div
                        ...
                        <button type="button" class="btn post"
                                style="font-size: 1.2rem;">Postar</button>
                    </div>
                </div>
...
<script src="DonoComunidade.js"></script>
</body>
</html>
